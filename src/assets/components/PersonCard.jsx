...
function PersonCard(props) {
  return (
    <Link to={""} className='basis-[100%] bigphone:basis-[40%] bigphone:w-[50%]  tablet:w-[30%] tablet:basis-[23%]   h-[40%] m-1 mb-4 group hover:scale-100 transition-all cursor-pointer '>
