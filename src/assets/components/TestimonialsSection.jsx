...
function TestimonialsSection() {
    let i=1;
    const [testimonial, setTestimonial] = useState(content[0])
 
    const handleNextSlide = ()=>{
        setTestimonial(content[i++])
    }
    ...
    <button onClick={()=>handlePrevSlide()} type='button' className='p-3 rounded-full hover:bg-gray-300'>
    ...
    <img src={testimonial.image} className='w-full h-full object-contain grayscale-[100]'/>
    </div>
    </div>
    </div>
    </div>
