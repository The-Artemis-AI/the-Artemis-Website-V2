...
function SingleProductPage() {
  ...
  return (
    ...
    <div className=" w-full  mt-10 mx-auto items-center flex flex-col justify-betwee">
   ...
   {/* <div className='w-full bigphone:w-[50%] px-5 bigphone:px-1 my-2'>
    ...
    <div className='w-full h-[70px] bigphone:h-[100px] grayscale-[100] bg-gray-200 my-10' style={{backgroundImage:`url(${Image})`,  backgroundPosition:"center center", backgroundSize:"cover", backgroundRepeat:"no-repeat"}}> </div>
    </div>
    </div>
