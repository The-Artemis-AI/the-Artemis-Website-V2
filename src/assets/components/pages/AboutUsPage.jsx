...
function AboutUsPage() {
  return (
    ...
    <div className='w-[85%] h-[60%] mx-auto my-10 flex flex-row items-center justify-between'>
    <div className='w-[50%] my-2  '>
    
     <h3 className='text-5xl' style={{fontFamily:'Montserrat'}}>Our vision is lorem ipsum mipsum jispum.</h3>
    </div>
  ...
  {/* CEO WOrd */}
  <div className='w-full h-[60%] mx-auto my-10 px-20 flex flex-col items-center justify-center space-y-10 bg-yellow-200'>
  <h3 className='text-3xl text-center' style={{fontFamily:'Montserrat'}}>“Our goal is to is lorem In eu aliquet orci ac risus lobortis aenean diam aenean. Lorem ipsum dolor sit amet consectetur.”</h3>
