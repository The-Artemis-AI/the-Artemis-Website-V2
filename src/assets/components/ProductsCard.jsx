...
function ProductsCard(props) {
  return (
    <a href={"/the-Artemis-Website-V2" + props.Link} className='bigphone:w-[50%] bigphone:basis-[45%] tablet:w-[30%] tablet:basis-[30%] h-[40%] m-1 mb-4 group hover:scale-105 transition-all cursor-pointer'>
