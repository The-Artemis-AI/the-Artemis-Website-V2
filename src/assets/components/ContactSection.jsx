...
function ContactSection() {
  return (
    <div className='py-20 w-full p- px-20 bg-white items-center flex flex-col flex-wrap justify-between tablet:flex-row'>
    <div className='w-full tablet:w-[70%] '>
    <h1 className='text-2xl bigphone:text-4xl tablet:text-5xl mb-3'>Have a Project? Reach Out</h1>
    <form>
    <div className='input flex flex-col bigphone:flex-row justify-between my-2'>
    ...
    <p className='bg-gray-300 rounded-sm items-center justify-center flex flex-col p-2 w-[15%] text-sm'>+250</p>
    ...
    <button type='submit' className='bg-black text-gray-100 text-sm py-2 px-10 rounded-full mt-4'>Submit</button>
    </form>
    </div>
