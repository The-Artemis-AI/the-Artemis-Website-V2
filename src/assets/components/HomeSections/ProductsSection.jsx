...
function ProductsSection() {
  return (
    ...
    <div className='w-[80%] bigphone:w-[60%] tablet:h-[60%] my-auto flex flex-col items-center self-center tablet:items-start tablet:justify-center tablet:space-y-4 tablet:ml-4'>
    <h4 className='text-xl text-center mt-5 tablet:mt-1 '>Our Products</h4>
    <h1 className='mt-5 tablet:mt-1 text-3xl bigphone:text-6xl bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text text-transparent' style={{fontFamily:'Montserrat'}}>Servin 1.0</h1>
    <p className='mt-5 tablet:mt-1 w-[90%]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia quo natus voluptates repudi.Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia quo natus </p>
