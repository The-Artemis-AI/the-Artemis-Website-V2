...
function ProductsSection() {
  return (
    ...
    <div className='w-[80%] tablet:w-[40%] h-[40%] tablet:h-[100%] bigphone:h[120%] m-auto bg-blue-80 tablet:translate-y-[-10%] slide-in'>
    ...
    <Link
    //  to={"/the-Artemis-Website-V2/products/Seyvin"}
