...
function ProductsSection() {
  return (
    <div className='w-full h-full bigphone:px-20 p-10 mx-auto bg-gray-100 items-center flex flex-row'>
    ...
    <div className='w-[80%] bigphone:w-[60%] tablet:ht-[70%] my-auto flex flex-col items-center self-center tablet:items-start tablet:justify-center tablet:space-y-4  tablet:ml-4'>
    ...
    <p className='laptop:text-[1.1em] mt-5 tablet:mt-1 w-[80%]'>Introducing our flagship AI-powered document reader, revolutionizing data interaction by allowing users to 'chat' with their data. It seamlessly interprets and extracts valuable insights from various documents, making data analysis conversational and user-friendly. With Seyvin, data becomes an engaging dialogue, unlocking new levels of understanding and accessibility. </p>
